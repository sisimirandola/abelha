...
if __name__ == "__main__":
    ...
    for i, inc in enumerate(inclinations):
        ...
        v_map_bicone = bicone.main_bicone(N, extent, v0, vmax, rend, rturn, thetain_deg, thetaout_deg, modo_velocity, inc, pa_deg)
        ...
        v_map_esfera = bicone.main_esfera(N, extent, v0, vmax, rend, rturn, modo_velocity, inc, pa_deg)
